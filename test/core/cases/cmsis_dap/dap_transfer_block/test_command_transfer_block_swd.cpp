...
struct Command_DapTransferBlock_PortSwdIsConnected
    : public DapTransferBlockMockSwd {
  Command_DapTransferBlock_PortSwdIsConnected() {
    newCmsisDapMock();
    attachPortSwd();
    connectPortSwd();
  }
  virtual ~Command_DapTransferBlock_PortSwdIsConnected() {}
};

TEST_GROUP_BASE(Command_DapTransferBlock_PortSwdIsConnected_Count_1,
                Command_DapTransferBlock_PortSwdIsConnected) {
  void setup() {
    allocateCommand(9);
...
TEST(Command_DapTransferBlock_PortSwdIsConnected_Count_1, ReadApacc) {
  ...
  transfer_request.address = (0x2 << 2);
...
TEST(Command_DapTransferBlock_PortSwdIsConnected_Count_1, ReadDpacc) {
...
TEST(Command_DapTransferBlock_PortSwdIsConnected_Count_1, WriteApacc) {
  transfer_request.APnDP = true;
  transfer_request.transfer_request_type =
...
TEST(Command_DapTransferBlock_PortSwdIsConnected_Count_1, WriteDpacc) {
  transfer_request.APnDP = false;
  transfer_request.transfer_request_type =
      TransferRequest::kTransferTypeNormalWrite;
...
TEST_GROUP_BASE(Command_DapTransferBlock_PortSwdIsConnected_Count_2,
                Command_DapTransferBlock_PortSwdIsConnected) {
  void setup() {
    allocateCommand(13);
...
TEST(Command_DapTransferBlock_PortSwdIsConnected_Count_2, ReadApacc) {
  transfer_request.APnDP = true;
  transfer_request.transfer_request_type =
      TransferRequest::kTransferTypeNormalRead;
...
TEST(Command_DapTransferBlock_PortSwdIsConnected_Count_2, ReadDpacc) {
  transfer_request.APnDP = false;
  transfer_request.transfer_request_type =
      TransferRequest::kTransferTypeNormalRead;
  ...
  setMockReadDpacc(&response_data[0]);
  setMockReadDpacc(&response_data[1]);
  commandCmsisDap();
  checkResponse(2, CmsisDap::kTransferAckOk, &transfer_request, response_data);
}

TEST(Command_DapTransferBlock_PortSwdIsConnected_Count_2, WriteApacc) {
  transfer_request.APnDP = true;
  transfer_request.transfer_request_type =
      TransferRequest::kTransferTypeNormalWrite;
  ...
  setCommand(0x5a, 2, &transfer_request, transfer_data);
  setMockWrite(transfer_data[0]);
  setMockWrite(transfer_data[1]);
  setMockReadRdbuff(&response_data[1]);
  commandCmsisDap();
  checkResponse(2, CmsisDap::kTransferAckOk, &transfer_request, response_data);
}

TEST(Command_DapTransferBlock_PortSwdIsConnected_Count_2, WriteDpacc) {
  transfer_request.APnDP = false;
  transfer_request.transfer_request_type =
      TransferRequest::kTransferTypeNormalWrite;
...
TEST_GROUP_BASE(Command_DapTransferBlock_PortSwdIsConnected_Count_255,
                Command_DapTransferBlock_PortSwdIsConnected) {
  void setup() {
...
TEST(Command_DapTransferBlock_PortSwdIsConnected_Count_255, ReadApacc) {
  transfer_request.APnDP = true;
  transfer_request.transfer_request_type =
      TransferRequest::kTransferTypeNormalRead;
...
TEST(Command_DapTransferBlock_PortSwdIsConnected_Count_255, ReadDpacc) {
  transfer_request.APnDP = false;
  transfer_request.transfer_request_type =
      TransferRequest::kTransferTypeNormalRead;
...
TEST(Command_DapTransferBlock_PortSwdIsConnected_Count_255, WriteApacc) {
  transfer_request.APnDP = true;
  transfer_request.transfer_request_type =
      TransferRequest::kTransferTypeNormalWrite;
...
TEST(Command_DapTransferBlock_PortSwdIsConnected_Count_255, WriteDpacc) {
  transfer_request.APnDP = false;
  transfer_request.transfer_request_type =
      TransferRequest::kTransferTypeNormalWrite;
...
TEST_GROUP_BASE(Command_DapTransferBlock_PortSwdIsConnected_Count_256,
                Command_DapTransferBlock_PortSwdIsConnected) {
  void setup() {
...
TEST(Command_DapTransferBlock_PortSwdIsConnected_Count_256, ReadApacc) {
  transfer_request.APnDP = true;
  transfer_request.transfer_request_type =
      TransferRequest::kTransferTypeNormalRead;
...
TEST(Command_DapTransferBlock_PortSwdIsConnected_Count_256, ReadDpacc) {
  transfer_request.APnDP = false;
  transfer_request.transfer_request_type =
      TransferRequest::kTransferTypeNormalRead;
...
TEST(Command_DapTransferBlock_PortSwdIsConnected_Count_256, WriteApacc) {
  transfer_request.APnDP = true;
  transfer_request.transfer_request_type =
      TransferRequest::kTransferTypeNormalWrite;
...
TEST(Command_DapTransferBlock_PortSwdIsConnected_Count_256, WriteDpacc) {
  transfer_request.APnDP = false;
  transfer_request.transfer_request_type =
      TransferRequest::kTransferTypeNormalWrite;
